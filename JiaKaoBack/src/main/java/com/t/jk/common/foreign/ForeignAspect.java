package com.t.jk.common.foreign;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.service.IService;
import com.t.jk.common.foreign.anno.ForeignCascade;
import com.t.jk.common.foreign.anno.ForeignField;
import com.t.jk.common.foreign.anno.ForeignField.ForeignFields;
import com.t.jk.common.foreign.info.ForeignFieldInfo;
import com.t.jk.common.foreign.info.ForeignTableInfo;
import com.t.jk.common.util.Classes;
import com.t.jk.common.util.JsonVos;
import com.t.jk.common.util.Strings;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:com/t/jk/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* com.t.jk.service..*.remove*(..))")
    public Object handleRemove(ProceedingJoinPoint point) throws Throwable {
        ...
        for (ForeignFieldInfo subField : subFields) {
            ...
            if (mainField.getCascade() == ForeignCascade.DEFAULT) { // 默认
                Long count = Long.valueOf(mapper.selectCount(wrapper));
                if (count == 0) continue;
    ...
    @Around("execution(* com.t.jk.service..*.save*(..)) || execution(* com.t.jk.service..*.update*(..)) ")
